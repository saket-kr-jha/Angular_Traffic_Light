...
export type TrafficLightConfig<Colors extends DefaultColors> = Record<
  Colors,
  ColorConfig<Colors>
>;
...
export class TrafficLightComponent<Colors extends DefaultColors>
  implements OnInit, OnDestroy
{
  ...
  trafficLightOrder = (a: ColorConfig<Colors>, b: ColorConfig<Colors>) =>
    a.order > b.order ? -1 : 1;
